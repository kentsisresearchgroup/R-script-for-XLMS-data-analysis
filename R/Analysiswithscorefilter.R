...
#Score cutoffs
s1=109.2  #ETDMS2 humandb
s2=83.1  #HCDMS2 humandb
s3=101.3  #EThcDMS2 humandb
s4=108.5  #HCDMS3 humandb
s5=104.3  #ETDMS2_hek humandb
s6=101.2  #HCDMS2_hek humandb
s7=101.2  #EThcDMS2_hek humandb
s8=134.7  #HCDMS3_hek humandb
s9=109.2 #ETDMS2 bsadb
s10=83.1 #HCDMS2 bsadb
s11=101.3 #EThcDMS2 bsadb
s12=108.5 #HCDMS3 bsadb
s13=104.3 #ETDMS2_hek bsadb
s14=101.2 #HCDMS2_hek bsadb
s15=101.2 #EThcDMS2_hek bsadb
s16=134.7 #HCDMS3_hek bsadb
...
##Compile all replicates, filter XlinkX score
ETD_xlBSA_hdb=rbind(ETD1_xlBSA_hdb,ETD2_xlBSA_hdb,ETD3_xlBSA_hdb)
ETD_xlBSA_hdb=ETD_xlBSA_hdb[ETD_xlBSA_hdb[,"Max.XlinkX.Score"]>s1,]
write.table(ETD_xlBSA_hdb,"20170830_ETDMS2_xlBSA_hdb_1err.txt",sep="\t",row.names=FALSE)
...
write.table(ETD_xlBSA_hdb_bsaonly,"20170830_ETDMS2_xlBSA_hdb_BSAonly_1err.txt",sep="\t",row.names=FALSE)
...
write.table(ETD_xlBSA_hdb_nonbsa,"20170830_ETDMS2_xlBSA_hdb_nonBSAonly_1err.txt",sep="\t",row.names=FALSE)
...
write.table(ETD_xlBSA_hdb_dup,"20170830_ETDMS2_xlBSA_hdb_BSAonly_nodup_1err.txt",sep="\t",row.names=FALSE)
#For XiNET export
...
write.csv(ETD_xlBSA_hdb_xinet,"20170830_ETDMS2_xlBSA_hdb_xinet_1err.csv",row.names=FALSE)
...
tiff('ETD_xlBSA_hdb_replicates_1err.tiff',width=10, height=10, units="in", res=300)
...
grid.arrange(gTree(children=g),top=textGrob("ETD_xlBSA_hdb_replicates_1err",gp=gpar(fontsize=32,fontface=2)))
dev.off()
...
HCD_xlBSA_hdb=HCD_xlBSA_hdb[HCD_xlBSA_hdb[,"Max.XlinkX.Score"]>s2,]
write.table(HCD_xlBSA_hdb,"20170830_HCDMS2_xlBSA_hdb_1err.txt",sep="\t",row.names=FALSE)
##Reposition, PositionA>PositionB
...
write.table(HCD_xlBSA_hdb_bsaonly,"20170830_HCDMS2_xlBSA_hdb_BSAonly_1err.txt",sep="\t",row.names=FALSE)
##Non-BSA cross-links, duplicates kept
HCD_xlBSA_hdb_nonbsa<- HCD_xlBSA_hdb[!grepl("P02769", HCD_xlBSA_hdb[["Accession.A"]]) | !grepl("P02769", HCD_xlBSA_hdb[["Accession.B"]]), ]
write.table(HCD_xlBSA_hdb_nonbsa,"20170830_HCDMS2_xlBSA_hdb_nonBSAonly_1err.txt",sep="\t",row.names=FALSE)
##Remove duplicates after keeping BSA cross-links
HCD_xlBSA_hdb_dup=HCD_xlBSA_hdb_bsaonly[!duplicated(HCD_xlBSA_hdb_bsaonly[c("PositionA","PositionB")]),]
write.table(HCD_xlBSA_hdb_dup,"20170830_HCDMS2_xlBSA_hdb_BSAonly_nodup_1err.txt",sep="\t",row.names=FALSE)
#For XiNET export
...
write.csv(HCD_xlBSA_hdb_xinet,"20170830_HCDMS2_xlBSA_hdb_xinet_1err.csv",row.names=FALSE)
###For individual replicates
#Reposition, PositionA>PositionB
...
tiff('HCD_xlBSA_hdb_replicates_1err.tiff',width=10, height=10, units="in", res=300)
...
category=c("Replicate1","Replicate2","Replicate3"),lwd=2,
fill=c("blue","red","green"),cex=3,cat.cex=2,cat.fontface=2,euler.d=FALSE,scaled=FALSE)
grid.arrange(gTree(children=g),top=textGrob("HCD_xlBSA_hdb_replicates_1err",gp=gpar(fontsize=32,fontface=2)))
dev.off()
...
ETHCD_xlBSA_hdb=ETHCD_xlBSA_hdb[ETHCD_xlBSA_hdb[,"Max.XlinkX.Score"]>s3,]
write.table(ETHCD_xlBSA_hdb,"20170830_ETHCDMS2_xlBSA_hdb_1err.txt",sep="\t",row.names=FALSE)
##Reposition, PositionA>PositionB
...
write.table(ETHCD_xlBSA_hdb_bsaonly,"20170830_ETHCDMS2_xlBSA_hdb_BSAonly_1err.txt",sep="\t",row.names=FALSE)
##Non-BSA cross-links, duplicates kept
ETHCD_xlBSA_hdb_nonbsa<- ETHCD_xlBSA_hdb[!grepl("P02769", ETHCD_xlBSA_hdb[["Accession.A"]]) | !grepl("P02769", ETHCD_xlBSA_hdb[["Accession.B"]]), ]
write.table(ETHCD_xlBSA_hdb_nonbsa,"20170830_ETHCDMS2_xlBSA_hdb_nonBSAonly_1err.txt",sep="\t",row.names=FALSE)
##Remove duplicates after keeping BSA cross-links
ETHCD_xlBSA_hdb_dup=ETHCD_xlBSA_hdb_bsaonly[!duplicated(ETHCD_xlBSA_hdb_bsaonly[c("PositionA","PositionB")]),]
write.table(ETHCD_xlBSA_hdb_dup,"20170830_ETHCDMS2_xlBSA_hdb_BSAonly_nodup_1err.txt",sep="\t",row.names=FALSE)
#For XiNET export
...
write.csv(ETHCD_xlBSA_hdb_xinet,"20170830_ETHCDMS2_xlBSA_hdb_xinet_1err.csv",row.names=FALSE)
###For individual replicates
#Reposition, PositionA>PositionB
...
tiff('ETHCD_xlBSA_hdb_replicates_1err.tiff',width=10, height=10, units="in", res=300)
...
category=c("Replicate1","Replicate2","Replicate3"),lwd=2,
fill=c("blue","red","green"),cex=3,cat.cex=2,cat.fontface=2,euler.d=FALSE,scaled=FALSE)
grid.arrange(gTree(children=g),top=textGrob("ETHCD_xlBSA_hdb_replicates_1err",gp=gpar(fontsize=32,fontface=2)))
dev.off()
...
HCDMS3_xlBSA_hdb=HCDMS3_xlBSA_hdb[HCDMS3_xlBSA_hdb[,"Max.XlinkX.Score"]>s4,]
write.table(HCDMS3_xlBSA_hdb,"20170830_HCDMS3_xlBSA_hdb_1err.txt",sep="\t",row.names=FALSE)
##Reposition, PositionA>PositionB
...
write.table(HCDMS3_xlBSA_hdb_bsaonly,"20170830_HCDMS3_xlBSA_hdb_BSAonly_1err.txt",sep="\t",row.names=FALSE)
##Non-BSA cross-links, duplicates kept
...
write.table(HCDMS3_xlBSA_hdb_nonbsa,"20170830_HCDMS3_xlBSA_hdb_nonBSAonly_1err.txt",sep="\t",row.names=FALSE)
##Remove duplicates after keeping BSA cross-links
HCDMS3_xlBSA_hdb_dup=HCDMS3_xlBSA_hdb_bsaonly[!duplicated(HCDMS3_xlBSA_hdb_bsaonly[c("PositionA","PositionB")]),]
write.table(HCDMS3_xlBSA_hdb_dup,"20170830_HCDMS3_xlBSA_hdb_BSAonly_nodup_1err.txt",sep="\t",row.names=FALSE)
#For XiNET export
...
write.csv(HCDMS3_xlBSA_hdb_xinet,"20170830_HCDMS3_xlBSA_hdb_xinet_1err.csv",row.names=FALSE)
###For individual replicates
#Reposition, PositionA>PositionB
...
tiff('HCDMS3_xlBSA_hdb_replicates_1err.tiff',width=10, height=10, units="in", res=300)
...
category=c("Replicate1","Replicate2","Replicate3"),lwd=2,
fill=c("blue","red","green"),cex=3,cat.cex=2,cat.fontface=2,euler.d=FALSE,scaled=FALSE)
grid.arrange(gTree(children=g),top=textGrob("HCDMS3_xlBSA_hdb_replicates_1err",gp=gpar(fontsize=32,fontface=2)))
dev.off()
...
ETD_xlBSA_293_hdb=ETD_xlBSA_293_hdb[ETD_xlBSA_293_hdb[,"Max.XlinkX.Score"]>s5,]
write.table(ETD_xlBSA_293_hdb,"20170830_ETDMS2_xlBSA_293_hdb_1err.txt",sep="\t",row.names=FALSE)
##Reposition, PositionA>PositionB
...
write.table(ETD_xlBSA_293_hdb_bsaonly,"20170830_ETDMS2_xlBSA_293_hdb_BSAonly_1err.txt",sep="\t",row.names=FALSE)
##Non-BSA cross-links, duplicates kept
...
write.table(ETD_xlBSA_293_hdb_nonbsa,"20170830_ETDMS2_xlBSA_293_hdb_nonBSAonly_1err.txt",sep="\t",row.names=FALSE)
##Remove duplicates after keeping BSA cross-links
ETD_xlBSA_293_hdb_dup=ETD_xlBSA_293_hdb_bsaonly[!duplicated(ETD_xlBSA_293_hdb_bsaonly[c("PositionA","PositionB")]),]
write.table(ETD_xlBSA_293_hdb_dup,"20170830_ETDMS2_xlBSA_293_hdb_BSAonly_nodup_1err.txt",sep="\t",row.names=FALSE)
#For XiNET export
...
write.csv(ETD_xlBSA_293_hdb_xinet,"20170830_ETDMS2_xlBSA_293_hdb_xinet_1err.csv",row.names=FALSE)
###For individual replicates
#Reposition, PositionA>PositionB
...
tiff('ETD_xlBSA_293_hdb_replicates_1err.tiff',width=10, height=10, units="in", res=300)
...
category=c("Replicate1","Replicate2","Replicate3"),lwd=2,
fill=c("blue","red","green"),cex=3,cat.cex=2,cat.fontface=2,euler.d=FALSE,scaled=FALSE)
grid.arrange(gTree(children=g),top=textGrob("ETD_xlBSA_293_hdb_replicates_1err",gp=gpar(fontsize=32,fontface=2)))
dev.off()
...
HCD_xlBSA_293_hdb=HCD_xlBSA_293_hdb[HCD_xlBSA_293_hdb[,"Max.XlinkX.Score"]>s6,]
write.table(HCD_xlBSA_293_hdb,"20170830_HCDMS2_xlBSA_293_hdb_1err.txt",sep="\t",row.names=FALSE)
##Reposition, PositionA>PositionB
...
write.table(HCD_xlBSA_293_hdb_bsaonly,"20170830_HCDMS2_xlBSA_293_hdb_BSAonly_1err.txt",sep="\t",row.names=FALSE)
##Non-BSA cross-links, duplicates kept
...
write.table(HCD_xlBSA_293_hdb_nonbsa,"20170830_HCDMS2_xlBSA_293_hdb_nonBSAonly_1err.txt",sep="\t",row.names=FALSE)
##Remove duplicates after keeping BSA cross-links
HCD_xlBSA_293_hdb_dup=HCD_xlBSA_293_hdb_bsaonly[!duplicated(HCD_xlBSA_293_hdb_bsaonly[c("PositionA","PositionB")]),]
write.table(HCD_xlBSA_293_hdb_dup,"20170830_HCDMS2_xlBSA_293_hdb_BSAonly_nodup_1err.txt",sep="\t",row.names=FALSE)
#For XiNET export
...
write.csv(HCD_xlBSA_293_hdb_xinet,"20170830_HCDMS2_xlBSA_293_hdb_xinet_1err.csv",row.names=FALSE)
###For individual replicates
#Reposition, PositionA>PositionB
...
tiff('HCD_xlBSA_293_hdb_replicates_1err.tiff',width=10, height=10, units="in", res=300)
...
category=c("Replicate1","Replicate2","Replicate3"),lwd=2,
fill=c("blue","red","green"),cex=3,cat.cex=2,cat.fontface=2,euler.d=FALSE,scaled=FALSE)
grid.arrange(gTree(children=g),top=textGrob("HCD_xlBSA_293_hdb_replicates_1err",gp=gpar(fontsize=32,fontface=2)))
dev.off()
...
ETHCD_xlBSA_293_hdb=ETHCD_xlBSA_293_hdb[ETHCD_xlBSA_293_hdb[,"Max.XlinkX.Score"]>s7,]
write.table(ETHCD_xlBSA_293_hdb,"20170830_ETHCDMS2_xlBSA_293_hdb_1err.txt",sep="\t",row.names=FALSE)
##Reposition, PositionA>PositionB
...
write.table(ETHCD_xlBSA_293_hdb_bsaonly,"20170830_ETHCDMS2_xlBSA_293_hdb_BSAonly_1err.txt",sep="\t",row.names=FALSE)
##Non-BSA cross-links, duplicates kept
...
write.table(ETHCD_xlBSA_293_hdb_nonbsa,"20170830_ETHCDMS2_xlBSA_293_hdb_nonBSAonly_1err.txt",sep="\t",row.names=FALSE)
##Remove duplicates after keeping BSA cross-links
ETHCD_xlBSA_293_hdb_dup=ETHCD_xlBSA_293_hdb_bsaonly[!duplicated(ETHCD_xlBSA_293_hdb_bsaonly[c("PositionA","PositionB")]),]
write.table(ETHCD_xlBSA_293_hdb_dup,"20170830_ETHCDMS2_xlBSA_293_hdb_BSAonly_nodup_1err.txt",sep="\t",row.names=FALSE)
#For XiNET export
...
write.csv(ETHCD_xlBSA_293_hdb_xinet,"20170830_ETHCDMS2_xlBSA_293_hdb_xinet_1err.csv",row.names=FALSE)
###For individual replicates
#Reposition, PositionA>PositionB
...
tiff('ETHCD_xlBSA_293_hdb_replicates_1err.tiff',width=10, height=10, units="in", res=300)
...
category=c("Replicate1","Replicate2","Replicate3"),lwd=2,
fill=c("blue","red","green"),cex=3,cat.cex=2,cat.fontface=2,euler.d=FALSE,scaled=FALSE)
grid.arrange(gTree(children=g),top=textGrob("ETHCD_xlBSA_293_hdb_replicates_1err",gp=gpar(fontsize=32,fontface=2)))
dev.off()
...
HCDMS3_xlBSA_293_hdb=HCDMS3_xlBSA_293_hdb[HCDMS3_xlBSA_293_hdb[,"Max.XlinkX.Score"]>s8,]
write.table(HCDMS3_xlBSA_293_hdb,"20170830_HCDMS3_xlBSA_293_hdb_1err.txt",sep="\t",row.names=FALSE)
##Reposition, PositionA>PositionB
...
write.table(HCDMS3_xlBSA_293_hdb_bsaonly,"20170830_HCDMS3_xlBSA_293_hdb_BSAonly_1err.txt",sep="\t",row.names=FALSE)
##Non-BSA cross-links, duplicates kept
...
write.table(HCDMS3_xlBSA_293_hdb_nonbsa,"20170830_HCDMS3_xlBSA_293_hdb_nonBSAonly_1err.txt",sep="\t",row.names=FALSE)
##Remove duplicates after keeping BSA cross-links
HCDMS3_xlBSA_293_hdb_dup=HCDMS3_xlBSA_293_hdb_bsaonly[!duplicated(HCDMS3_xlBSA_293_hdb_bsaonly[c("PositionA","PositionB")]),]
write.table(HCDMS3_xlBSA_293_hdb_dup,"20170830_HCDMS3_xlBSA_293_hdb_BSAonly_nodup_1err.txt",sep="\t",row.names=FALSE)
#For XiNET export
...
write.csv(HCDMS3_xlBSA_293_hdb_xinet,"20170830_HCDMS3_xlBSA_293_hdb_xinet_1err.csv",row.names=FALSE)
###For individual replicates
#Reposition, PositionA>PositionB
...
tiff('HCDMS3_xlBSA_293_hdb_replicates_1err.tiff',width=10, height=10, units="in", res=300)
...
category=c("Replicate1","Replicate2","Replicate3"),lwd=2,
fill=c("blue","red","green"),cex=3,cat.cex=2,cat.fontface=2,euler.d=FALSE,scaled=FALSE)
grid.arrange(gTree(children=g),top=textGrob("HCDMS3_xlBSA_293_hdb_replicates_1err",gp=gpar(fontsize=32,fontface=2)))
dev.off()
...
ETD_xlBSA_bsadb=ETD_xlBSA_bsadb[ETD_xlBSA_bsadb[,"Max.XlinkX.Score"]>s9,]
write.table(ETD_xlBSA_bsadb,"20170830_ETDMS2_xlBSA_bsadb_1err.txt",sep="\t",row.names=FALSE)
##Reposition, PositionA>PositionB
...
write.table(ETD_xlBSA_bsadb_bsaonly,"20170830_ETDMS2_xlBSA_bsadb_BSAonly_1err.txt",sep="\t",row.names=FALSE)
##Non-BSA cross-links, duplicates kept
ETD_xlBSA_bsadb_nonbsa<- ETD_xlBSA_bsadb[!grepl("P02769", ETD_xlBSA_bsadb[["Accession.A"]]) | !grepl("P02769", ETD_xlBSA_bsadb[["Accession.B"]]), ]
write.table(ETD_xlBSA_bsadb_nonbsa,"20170830_ETDMS2_xlBSA_bsadb_nonBSAonly_1err.txt",sep="\t",row.names=FALSE)
##Remove duplicates after keeping BSA cross-links
ETD_xlBSA_bsadb_dup=ETD_xlBSA_bsadb_bsaonly[!duplicated(ETD_xlBSA_bsadb_bsaonly[c("PositionA","PositionB")]),]
write.table(ETD_xlBSA_bsadb_dup,"20170830_ETDMS2_xlBSA_bsadb_BSAonly_nodup_1err.txt",sep="\t",row.names=FALSE)
#For XiNET export
...
write.csv(ETD_xlBSA_bsadb_xinet,"20170830_ETDMS2_xlBSA_bsadb_xinet_1err.csv",row.names=FALSE)
###For individual replicates
#Reposition, PositionA>PositionB
...
tiff('ETD_xlBSA_bsadb_replicates_1err.tiff',width=10, height=10, units="in", res=300)
...
category=c("Replicate1","Replicate2","Replicate3"),lwd=2,
fill=c("blue","red","green"),cex=3,cat.cex=2,cat.fontface=2,euler.d=FALSE,scaled=FALSE)
grid.arrange(gTree(children=g),top=textGrob("ETD_xlBSA_bsadb_replicates_1err",gp=gpar(fontsize=32,fontface=2)))
dev.off()
...
HCD_xlBSA_bsadb=HCD_xlBSA_bsadb[HCD_xlBSA_bsadb[,"Max.XlinkX.Score"]>s10,]
write.table(HCD_xlBSA_bsadb,"20170830_HCDMS2_xlBSA_bsadb_1err.txt",sep="\t",row.names=FALSE)
##Reposition, PositionA>PositionB
...
write.table(HCD_xlBSA_bsadb_bsaonly,"20170830_HCDMS2_xlBSA_bsadb_BSAonly_1err.txt",sep="\t",row.names=FALSE)
##Non-BSA cross-links, duplicates kept
HCD_xlBSA_bsadb_nonbsa<- HCD_xlBSA_bsadb[!grepl("P02769", HCD_xlBSA_bsadb[["Accession.A"]]) | !grepl("P02769", HCD_xlBSA_bsadb[["Accession.B"]]), ]
write.table(HCD_xlBSA_bsadb_nonbsa,"20170830_HCDMS2_xlBSA_bsadb_nonBSAonly_1err.txt",sep="\t",row.names=FALSE)
##Remove duplicates after keeping BSA cross-links
HCD_xlBSA_bsadb_dup=HCD_xlBSA_bsadb_bsaonly[!duplicated(HCD_xlBSA_bsadb_bsaonly[c("PositionA","PositionB")]),]
write.table(HCD_xlBSA_bsadb_dup,"20170830_HCDMS2_xlBSA_bsadb_BSAonly_nodup_1err.txt",sep="\t",row.names=FALSE)
#For XiNET export
...
write.csv(HCD_xlBSA_bsadb_xinet,"20170830_HCDMS2_xlBSA_bsadb_xinet_1err.csv",row.names=FALSE)
###For individual replicates
#Reposition, PositionA>PositionB
...
tiff('HCD_xlBSA_bsadb_replicates_1err.tiff',width=10, height=10, units="in", res=300)
...
category=c("Replicate1","Replicate2","Replicate3"),lwd=2,
fill=c("blue","red","green"),cex=3,cat.cex=2,cat.fontface=2,euler.d=FALSE,scaled=FALSE)
grid.arrange(gTree(children=g),top=textGrob("HCD_xlBSA_bsadb_replicates_1err",gp=gpar(fontsize=32,fontface=2)))
dev.off()
...
ETHCD_xlBSA_bsadb=ETHCD_xlBSA_bsadb[ETHCD_xlBSA_bsadb[,"Max.XlinkX.Score"]>s11,]
write.table(ETHCD_xlBSA_bsadb,"20170830_ETHCDMS2_xlBSA_bsadb_1err.txt",sep="\t",row.names=FALSE)
##Reposition, PositionA>PositionB
...
write.table(ETHCD_xlBSA_bsadb_bsaonly,"20170830_ETHCDMS2_xlBSA_bsadb_BSAonly_1err.txt",sep="\t",row.names=FALSE)
##Non-BSA cross-links, duplicates kept
...
write.table(ETHCD_xlBSA_bsadb_nonbsa,"20170830_ETHCDMS2_xlBSA_bsadb_nonBSAonly_1err.txt",sep="\t",row.names=FALSE)
##Remove duplicates after keeping BSA cross-links
ETHCD_xlBSA_bsadb_dup=ETHCD_xlBSA_bsadb_bsaonly[!duplicated(ETHCD_xlBSA_bsadb_bsaonly[c("PositionA","PositionB")]),]
write.table(ETHCD_xlBSA_bsadb_dup,"20170830_ETHCDMS2_xlBSA_bsadb_BSAonly_nodup_1err.txt",sep="\t",row.names=FALSE)
#For XiNET export
...
write.csv(ETHCD_xlBSA_bsadb_xinet,"20170830_ETHCDMS2_xlBSA_bsadb_xinet_1err.csv",row.names=FALSE)
###For individual replicates
#Reposition, PositionA>PositionB
...
tiff('ETHCD_xlBSA_bsadb_replicates_1err.tiff',width=10, height=10, units="in", res=300)
...
category=c("Replicate1","Replicate2","Replicate3"),lwd=2,
fill=c("blue","red","green"),cex=3,cat.cex=2,cat.fontface=2,euler.d=FALSE,scaled=FALSE)
grid.arrange(gTree(children=g),top=textGrob("ETHCD_xlBSA_bsadb_replicates_1err",gp=gpar(fontsize=32,fontface=2)))
dev.off()
...
HCDMS3_xlBSA_bsadb=HCDMS3_xlBSA_bsadb[HCDMS3_xlBSA_bsadb[,"Max.XlinkX.Score"]>s12,]
write.table(HCDMS3_xlBSA_bsadb,"20170830_HCDMS3_xlBSA_bsadb_1err.txt",sep="\t",row.names=FALSE)
##Reposition, PositionA>PositionB
...
write.table(HCDMS3_xlBSA_bsadb_bsaonly,"20170830_HCDMS3_xlBSA_bsadb_BSAonly_1err.txt",sep="\t",row.names=FALSE)
##Non-BSA cross-links, duplicates kept
...
write.table(HCDMS3_xlBSA_bsadb_nonbsa,"20170830_HCDMS3_xlBSA_bsadb_nonBSAonly_1err.txt",sep="\t",row.names=FALSE)
##Remove duplicates after keeping BSA cross-links
HCDMS3_xlBSA_bsadb_dup=HCDMS3_xlBSA_bsadb_bsaonly[!duplicated(HCDMS3_xlBSA_bsadb_bsaonly[c("PositionA","PositionB")]),]
write.table(HCDMS3_xlBSA_bsadb_dup,"20170830_HCDMS3_xlBSA_bsadb_BSAonly_nodup_1err.txt",sep="\t",row.names=FALSE)
#For XiNET export
...
write.csv(HCDMS3_xlBSA_bsadb_xinet,"20170830_HCDMS3_xlBSA_bsadb_xinet_1err.csv",row.names=FALSE)
###For individual replicates
#Reposition, PositionA>PositionB
...
tiff('HCDMS3_xlBSA_bsadb_replicates_1err.tiff',width=10, height=10, units="in", res=300)
...
category=c("Replicate1","Replicate2","Replicate3"),lwd=2,
fill=c("blue","red","green"),cex=3,cat.cex=2,cat.fontface=2,euler.d=FALSE,scaled=FALSE)
grid.arrange(gTree(children=g),top=textGrob("HCDMS3_xlBSA_bsadb_replicates_1err",gp=gpar(fontsize=32,fontface=2)))
dev.off()
...
ETD_xlBSA_293_bsadb=ETD_xlBSA_293_bsadb[ETD_xlBSA_293_bsadb[,"Max.XlinkX.Score"]>s13,]
write.table(ETD_xlBSA_293_bsadb,"20170830_ETDMS2_xlBSA_293_bsadb_1err.txt",sep="\t",row.names=FALSE)
##Reposition, PositionA>PositionB
...
write.table(ETD_xlBSA_293_bsadb_bsaonly,"20170830_ETDMS2_xlBSA_293_bsadb_BSAonly_1err.txt",sep="\t",row.names=FALSE)
##Non-BSA cross-links, duplicates kept
...
write.table(ETD_xlBSA_293_bsadb_nonbsa,"20170830_ETDMS2_xlBSA_293_bsadb_nonBSAonly_1err.txt",sep="\t",row.names=FALSE)
##Remove duplicates after keeping BSA cross-links
ETD_xlBSA_293_bsadb_dup=ETD_xlBSA_293_bsadb_bsaonly[!duplicated(ETD_xlBSA_293_bsadb_bsaonly[c("PositionA","PositionB")]),]
write.table(ETD_xlBSA_293_bsadb_dup,"20170830_ETDMS2_xlBSA_293_bsadb_BSAonly_nodup_1err.txt",sep="\t",row.names=FALSE)
#For XiNET export
...
write.csv(ETD_xlBSA_293_bsadb_xinet,"20170830_ETDMS2_xlBSA_293_bsadb_xinet_1err.csv",row.names=FALSE)
###For individual replicates
#Reposition, PositionA>PositionB
...
tiff('ETD_xlBSA_293_bsadb_replicates_1err.tiff',width=10, height=10, units="in", res=300)
...
category=c("Replicate1","Replicate2","Replicate3"),lwd=2,
fill=c("blue","red","green"),cex=3,cat.cex=2,cat.fontface=2,euler.d=FALSE,scaled=FALSE)
grid.arrange(gTree(children=g),top=textGrob("ETD_xlBSA_293_bsadb_replicates_1err",gp=gpar(fontsize=32,fontface=2)))
dev.off()
...
HCD_xlBSA_293_bsadb=HCD_xlBSA_293_bsadb[HCD_xlBSA_293_bsadb[,"Max.XlinkX.Score"]>s14,]
write.table(HCD_xlBSA_293_bsadb,"20170830_HCDMS2_xlBSA_293_bsadb_1err.txt",sep="\t",row.names=FALSE)
##Reposition, PositionA>PositionB
...
write.table(HCD_xlBSA_293_bsadb_bsaonly,"20170830_HCDMS2_xlBSA_293_bsadb_BSAonly_1err.txt",sep="\t",row.names=FALSE)
##Non-BSA cross-links, duplicates kept
...
write.table(HCD_xlBSA_293_bsadb_nonbsa,"20170830_HCDMS2_xlBSA_293_bsadb_nonBSAonly_1err.txt",sep="\t",row.names=FALSE)
##Remove duplicates after keeping BSA cross-links
HCD_xlBSA_293_bsadb_dup=HCD_xlBSA_293_bsadb_bsaonly[!duplicated(HCD_xlBSA_293_bsadb_bsaonly[c("PositionA","PositionB")]),]
write.table(HCD_xlBSA_293_bsadb_dup,"20170830_HCDMS2_xlBSA_293_bsadb_BSAonly_nodup_1err.txt",sep="\t",row.names=FALSE)
#For XiNET export
...
write.csv(HCD_xlBSA_293_bsadb_xinet,"20170830_HCDMS2_xlBSA_293_bsadb_xinet_1err.csv",row.names=FALSE)
###For individual replicates
#Reposition, PositionA>PositionB
...
tiff('HCD_xlBSA_293_bsadb_replicates_1err.tiff',width=10, height=10, units="in", res=300)
...
category=c("Replicate1","Replicate2","Replicate3"),lwd=2,
fill=c("blue","red","green"),cex=3,cat.cex=2,cat.fontface=2,euler.d=FALSE,scaled=FALSE)
grid.arrange(gTree(children=g),top=textGrob("HCD_xlBSA_293_bsadb_replicates_1err",gp=gpar(fontsize=32,fontface=2)))
dev.off()
...
ETHCD_xlBSA_293_bsadb=ETHCD_xlBSA_293_bsadb[ETHCD_xlBSA_293_bsadb[,"Max.XlinkX.Score"]>s15,]
write.table(ETHCD_xlBSA_293_bsadb,"20170830_ETHCDMS2_xlBSA_293_bsadb_1err.txt",sep="\t",row.names=FALSE)
##Reposition, PositionA>PositionB
...
write.table(ETHCD_xlBSA_293_bsadb_bsaonly,"20170830_ETHCDMS2_xlBSA_293_bsadb_BSAonly_1err.txt",sep="\t",row.names=FALSE)
##Non-BSA cross-links, duplicates kept
...
write.table(ETHCD_xlBSA_293_bsadb_nonbsa,"20170830_ETHCDMS2_xlBSA_293_bsadb_nonBSAonly_1err.txt",sep="\t",row.names=FALSE)
##Remove duplicates after keeping BSA cross-links
ETHCD_xlBSA_293_bsadb_dup=ETHCD_xlBSA_293_bsadb_bsaonly[!duplicated(ETHCD_xlBSA_293_bsadb_bsaonly[c("PositionA","PositionB")]),]
write.table(ETHCD_xlBSA_293_bsadb_dup,"20170830_ETHCDMS2_xlBSA_293_bsadb_BSAonly_nodup_1err.txt",sep="\t",row.names=FALSE)
#For XiNET export
...
write.csv(ETHCD_xlBSA_293_bsadb_xinet,"20170830_ETHCDMS2_xlBSA_293_bsadb_xinet_1err.csv",row.names=FALSE)
###For individual replicates
#Reposition, PositionA>PositionB
...
tiff('ETHCD_xlBSA_293_bsadb_replicates_1err.tiff',width=10, height=10, units="in", res=300)
...
category=c("Replicate1","Replicate2","Replicate3"),lwd=2,
fill=c("blue","red","green"),cex=3,cat.cex=2,cat.fontface=2,euler.d=FALSE,scaled=FALSE)
grid.arrange(gTree(children=g),top=textGrob("ETHCD_xlBSA_293_bsadb_replicates_1err",gp=gpar(fontsize=32,fontface=2)))
dev.off()
...
HCDMS3_xlBSA_293_bsadb=HCDMS3_xlBSA_293_bsadb[HCDMS3_xlBSA_293_bsadb[,"Max.XlinkX.Score"]>s16,]
write.table(HCDMS3_xlBSA_293_bsadb,"20170830_HCDMS3_xlBSA_293_bsadb_1err.txt",sep="\t",row.names=FALSE)
##Reposition, PositionA>PositionB
...
write.table(HCDMS3_xlBSA_293_bsadb_bsaonly,"20170830_HCDMS3_xlBSA_293_bsadb_BSAonly_1err.txt",sep="\t",row.names=FALSE)
##Non-BSA cross-links, duplicates kept
...
write.table(HCDMS3_xlBSA_293_bsadb_nonbsa,"20170830_HCDMS3_xlBSA_293_bsadb_nonBSAonly_1err.txt",sep="\t",row.names=FALSE)
##Remove duplicates after keeping BSA cross-links
...
write.table(HCDMS3_xlBSA_293_bsadb_dup,"20170830_HCDMS3_xlBSA_293_bsadb_BSAonly_nodup_1err.txt",sep="\t",row.names=FALSE)
#For XiNET export
...
write.csv(HCDMS3_xlBSA_293_bsadb_xinet,"20170830_HCDMS3_xlBSA_293_bsadb_xinet_1err.csv",row.names=FALSE)
###For individual replicates
#Reposition, PositionA>PositionB
...
tiff('HCDMS3_xlBSA_293_bsadb_replicates_1err.tiff',width=10, height=10, units="in", res=300)
...
category=c("Replicate1","Replicate2","Replicate3"),lwd=2,
fill=c("blue","red","green"),cex=3,cat.cex=2,cat.fontface=2,euler.d=FALSE,scaled=FALSE)
grid.arrange(gTree(children=g),top=textGrob("HCDMS3_xlBSA_293_bsadb_replicates_1err",gp=gpar(fontsize=32,fontface=2)))
dev.off()
...
write.table(Crosslinks,"20170830_Crosslinkscompiled_1err.txt",sep="\t",row.names=FALSE)
